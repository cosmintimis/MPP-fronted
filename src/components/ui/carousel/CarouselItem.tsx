  ...
  return (
    <div className="carousel-card flex flex-col items-center justify-between">
      <div className="user-info text-center mb-4 flex justify-between items-center w-full px-8 pt-4">
        ...
        <svg xmlns="http://www.w3.org/2000/svg" onClick={() => updateUser(userId)} fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="green" className="w-6 h-6 cursor-pointer hover:stroke-green-600">
